        ...
        <div className="flex absolute right-24">
          <div>
            ...
            <ul className="flex items-center mr-4">
              ...
              <div className="w-64 h-[550px]  relative top-64 ">
                <div className="flex justify-center h-14 text-white bg-black  items-center">
                  <p>Cart</p>
                </div>
                <div className="flex items-start border-b-2 border-gray-200 pb-4 m-4">
                  <img
                ...
                <div className="flex items-start pb-4 m-4">
                  <img
                    className="w-14 h-full border-2"
                    src="https://adro.in/cdn/shop/products/H22-M-GOD-CH-F.jpg?v=1667277700&width=480"
                    alt="no img"
                ...
                <div className="relative p-4 top-32 ">
                  <p className="text-xl">Subtotal</p>
                  <p className=" text-xl border-b-2 border-gray-200 pb-2">$90.00</p>
                <button
